      ...
      <div class="row">
        <div class="col-xl-12 col-sm-12 col-12">
          <div class="breadcrumb-path mb-4">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Add Tracking Candidate</li>
            </ul>
            <h3>Add Tracking Candidate</h3>
          </div>
        </div>
        <div class="col-xl-12 col-sm-12 col-12">
          <div class="card">
        ...
        <div class="col-xl-12 col-sm-12 col-12">
          <div class="row">
            <div class="col-xl-12 col-sm-12 col-12">
              <div class="form-btn">
                <a @click="onCreateTracking" class="btn btn-apply w-auto">
                  <b-spinner
                    v-if="isCreating"
                    variant="success"
                    label="Spinning"
...
export default {
  ...
  methods: {
    async onCreateTracking() {
      const { status } = await createTrack(this.dataTracking);
      if (status === 200) {
